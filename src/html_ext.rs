...
pub trait ToggleableExt: std::ops::Deref<Target = Toggleable> + hobo::AsElement + Copy + Sized + 'static {
...
impl<D: std::ops::Deref<Target = Toggleable> + hobo::AsElement + Copy + Sized + 'static> ToggleableExt for D {}
